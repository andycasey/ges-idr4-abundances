...
""" Produce ensemble C 1 abundances from the Gaia-ESO Survey iDR4 WG11 data """

__author__ = 'Andy Casey <arc@ast.cam.ac.uk>'

import release

database, element, ion = ("arc", "C", 1)
ges = release.DataRelease(database)

# 2 lines (5052.1 and 5380.3) from 2 nodes (Lumba and CAUP)

# Lumba measurements for feh < -2.5 stars are bad, but may be salvageable.
